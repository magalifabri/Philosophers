...
$PHILO/$PHILO 4 410 200 t
$PHILO/$PHILO 4 410 200 test
$PHILO/$PHILO 4 410 200 200 t
$PHILO/$PHILO 4 410 200 200 test
$PHILO/$PHILO 4 410 200 200 3 t
$PHILO/$PHILO 4 410 200 200 3 test

# $PHILO/$PHILO 4 410 200 200 3
# $PHILO/$PHILO 4 410 200t200 200 3 # works, ft_atoi converts 200t200 to 200